      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2 order-2 lg:order-1">
             ...
             >
                Built to <br />
                <span className="text-muted-foreground/10">Endure.</span>
             </motion.h2>
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
             ...
             >
                ...
                <div className="relative z-10 w-full text-center">
                   ...
                   <h3 className="text-3xl font-black text-foreground uppercase tracking-tighter mb-4">Zero Fatigue <br/>Engineering</h3>
                   <p className="text-muted-foreground text-sm font-medium max-w-xs mx-auto uppercase tracking-widest leading-relaxed">Structural integrity maintained across 10,000+ cycle stress tests.</p>
                </div>
             </motion.div>
          </div>
        </div>
