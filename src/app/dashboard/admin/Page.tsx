...
// import KPICards from '../super-admin/_components/KPICards';
// import ActionableTables from '../super-admin/_components/ActionableTables';

// const WelcomeCard3D = dynamic(() => import('../super-admin/_components/WelcomeCard3D'), {
//     ssr: false,
//     loading: () => (
...
export default function AdminDashboardTestPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center bg-card border border-border rounded-3xl shadow-sm mt-10">
            <div className="w-16 h-16 bg-emerald-500/20 text-emerald-500 rounded-full flex items-center justify-center text-2xl mb-6">
                🚀
            </div>
            <h1 className="text-3xl font-black text-foreground mb-2">
                ADMIN ROUTE IS ALIVE!
            </h1>
            <p className="text-muted-foreground max-w-md mx-auto">
                If you can see this page on Vercel, it means your folder structure and Next.js router are working perfectly.
            </p>
        </div>
    );
}